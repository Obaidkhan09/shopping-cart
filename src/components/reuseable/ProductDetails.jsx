...
export default function ProductDetails() {
    ...
    //         id : 1,
    //         name: "iPhone X",
    //         description: "How do you describe X on iPhone",
    ...
    //     }
    // ];
    const products = useSelector(getItem);
                ...
                <Grid container style={{}}>
                    <Grid item xs={12} sm={5}>
                        <Paper elevation={3} style={{ borderRadius: 20 }}>
                            <img alt='' src={img} style={{ objectFit: 'fill', width: '100%', height: 'auto', borderRadius: 20, aspectRatio: 16 / 9 }} />
                        </Paper>
                    </Grid>
